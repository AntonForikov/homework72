    ...
    <div className='p-3'>
      ...
      <form onSubmit={onFormSubmit}>
        <div className="d-flex w-25 align-items-center justify-content-between my-2">
          ...
          <input className="form-control w-75" type="text" name="title" id="title" value={newDish.title} onChange={changeField} required/>
        </div>
        <div className="d-flex w-25 align-items-center justify-content-between my-2">
          <label htmlFor="image">Image:</label>
          <input className="form-control w-75" type="url" name="image" id="image"  value={newDish.image} onChange={changeField}/>
        </div>
        <div className="d-flex w-25 align-items-center justify-content-between my-2">
